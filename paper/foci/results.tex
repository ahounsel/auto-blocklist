...
evaluations. First, our system was able to discover hundreds of
...
\begin{table}[b]
  \begin{center}
    ...
    \begin{tabular}{ | l | r | r | r | }
      \hline
      Phrase length & Domains & Domains w/o Top 1k & Tested URLs \\ \hline
      Bigrams  & 964     & 655                & 1,000,000 \\
      Trigrams & 969     & 629                & 1,000,000 \\
      Total & 1,405 & \textbf{757} & 1,946,328  \\ 
      \hline
    \end{tabular}}
  \end{center}
...
\textit{Our system discovered hundreds of censored websites that are
not present on the Citizen Lab block list--the standard for censorship
...
Westerners. However, the relationship between Taiwan and China is so
strained to the point that the Chinese government has attempted to
silence logistics regarding Taiwan~\cite{wapo:taiwan}. As such, the
censorship of these popular websites might reflects China's domestic
and foreign policy.
...
50 domains discovered by FilteredWeb. \textit{Thus, CensorSeeker is
able to product a qualitatively different block list than that of
FilteredWeb}. We recommend putting these two block lists together to
create a single block list that is both wide in scope and large in
size.
...
censored domains with CensorSeeker than FilteredWeb. For domains that
