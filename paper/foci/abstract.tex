...
existing block lists, we develop CensorSeeker, which uses search
engines and natural language techniques to discover a much wider range
of websites that are censored in China. Using this tool, we create a
list of 757 websites outside the Alexa Top 1,000 that cover Chinese
politics, minority human rights organizations, and oppressed
religions. Importantly, \textit{none of the sites we discover are
